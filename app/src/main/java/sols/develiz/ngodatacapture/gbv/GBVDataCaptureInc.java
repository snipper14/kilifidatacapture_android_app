...
public class GBVDataCaptureInc extends BaseActivity implements View.OnClickListener, GBVDataView {
    ...
    private EditText etCounty, etSubCounty, etWard, etLocation, dp_activity_date,et_male_defilement_10_14,
            ...
            et_female_sgbv_24,
            et_refered_hosp,et_reported_by,et_police_post;
    ...
    public void initActivity(Bundle b) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(GBVDataCaptureInc.this, GbvReportingActivity.class);
    ...
    private void activityDate() {
        ...
        datepicker_activitydate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(GBVDataCaptureInc.this, date, myCalendar
    ...
    @Override
    public int initView() {
        return R.layout.activity_g_b_v_data_capture_inc;
    }
    private void initElement() {
        ...
        et_refered_hosp=findViewById(R.id.et_refered_hosp);
        et_reported_by=findViewById(R.id.et_reported_by);
        et_police_post=findViewById(R.id.et_police_post);
    ...
    public void onBackPressed() {
        ...
        GBVDataCaptureInc.super.onBackPressed();
        ...
        switch (view.getId()) {
            case R.id.btn_submit_info:
                if (isConnected(this)) {
                    ...
                    showAlert(GBVDataCaptureInc.this, "No Internet Connection");
...
//                finish();
    ...
    private void validateAndSendData() {
        ...
        total_refered_hospital = et_refered_hosp.getText().toString();
        police_post = et_police_post.getText().toString();
        ...
        if (count == 0) {
            ...
            map.put("police_post", police_post);
            ...
            map.put("total_male_start_psychological_support", "0");
            map.put("total_female_start_psychological_support", "0");
            map.put("total_male_complete_psychological_support", "0");
            map.put("total_female_complete_psychological_support", "0");
    ...
    public void displayVolleyError(String s, int statusCode) {
        ...
        if (statusCode == 422) {
            ...
            showAlert(GBVDataCaptureInc.this, "Server responded with error 500");
        } else if (statusCode == 419) {
            showAlert(GBVDataCaptureInc.this, "Server responded with error 419");
        } else {
            showAlert(GBVDataCaptureInc.this, "Unknown Server Error!!!");
        }
    }
    ...
    public void registrationApiResponse(String response) {
        ...
        startActivity(new Intent(GBVDataCaptureInc.this, GbvReportingActivity.class));
        finish();
    }
}